...
#ifndef GAINZCOIN_QT_GAINZCOINUNITS_H
#define GAINZCOIN_QT_GAINZCOINUNITS_H
...
/** GainzCoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class GainzCoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit GainzCoinUnits(QObject *parent);

    /** GainzCoin units.
      @note Source: https://en.gainzcoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        BTC,
...
typedef GainzCoinUnits::Unit GainzCoinUnit;

#endif // GAINZCOIN_QT_GAINZCOINUNITS_H
