...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<GainzCoinAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_gainzcoin-qt -platform xcb      # Linux
//     src/qt/test/test_gainzcoin-qt -platform windows  # Windows
//     src/qt/test/test_gainzcoin-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = GainzCoinUnits::formatWithUnit(unit, balance, false, GainzCoinUnits::separatorAlways);
    ...
    // Amount input
    GainzCoinAmountField* amountInput = receiveCoinsDialog.findChild<GainzCoinAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: gainzcoin:")) != -1);
