...
#ifndef GAINZCOIN_WALLET_WALLET_H
#define GAINZCOIN_WALLET_WALLET_H
...
public:
     ...
     * on this gainzcoin node, and set to 0 for transactions that were created
...
#endif // GAINZCOIN_WALLET_WALLET_H
