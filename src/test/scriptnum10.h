...
#ifndef GAINZCOIN_TEST_SCRIPTNUM10_H
#define GAINZCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from GainzCoin Core 0.10.0, for cross-comparison.
 */
public:
