...
public:
    CMainParams() {
        strNetworkID = "main";
        consensus.BIP16Height = 0; // Always active
        ...
        // Deployment of BIP68, BIP112, and BIP113. Always active
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].bit = 0;
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].nStartTime = Consensus::BIP9Deployment::ALWAYS_ACTIVE;
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].nTimeout = Consensus::BIP9Deployment::NO_TIMEOUT;

        // Deployment of SegWit (BIP141, BIP143, and BIP147) Always active
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1296688602, 0x1d00ffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        vSeeds.emplace_back("testnet-seed.gainzcoin.jonasschnelli.ch");
        vSeeds.emplace_back("seed.tbtc.petertodd.org");
        vSeeds.emplace_back("seed.testnet.gainzcoin.sprovoost.nl");
